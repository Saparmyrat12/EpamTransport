...
public class JdbcRouteDao implements RouteDao {
    ...
    public Optional<Route> findById(int id) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(SELECT_FROM_ROUTES_WHERE_ROUTE_ID)) {
    ...
    public void delete(int id) {
        try (PreparedStatement statement = connection.prepareStatement(DELETE_ROUTE_QUERY)) {
            statement.setInt(1, id);
